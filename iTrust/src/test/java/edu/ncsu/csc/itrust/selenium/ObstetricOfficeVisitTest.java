...
public class ObstetricOfficeVisitTest extends iTrustSeleniumTest{
	...
	public void testAddObstetricAppointment() throws Exception {
		...
		try {
			assertEquals("http://localhost:8080/iTrust/auth/hcp-uap/viewObstetricOfficeVisit.jsp", driver.getCurrentUrl());
		} catch (Error e) {
	...
	public void testAddObstetricRecord() throws Exception {
		driver = login("9000000012", "pw");
		assertLogged(TransactionType.HOME_VIEW, 9000000012L, 0L, "");
		assertEquals("iTrust - HCP Home", driver.getTitle());

...
public class DeliveryReportTest extends iTrustSeleniumTest{
	...
	public void testDeliveryReportChanges() throws Exception {
		driver = login("9000000012", "pw");
		assertLogged(TransactionType.HOME_VIEW, 9000000012L, 0L, "");
		assertEquals("iTrust - HCP Home", driver.getTitle());

		driver.findElement(By.linkText("Labor & Delivery Report")).click();
		...
		try {
			assertEquals("http://localhost:8080/iTrust/auth/hcp/viewLaborDeliveryReport.jsp", driver.getCurrentUrl());
		} catch (Error e) {
		...
		driver.findElement(By.name("lowLyingPlacentaObserved")).sendKeys("70000");
		driver.findElement(By.name("numberOfBabies")).sendKeys("70000");
		...
		driver.findElement(By.linkText("Labor & Delivery Report")).click();
		assertTrue(driver.getPageSource().contains("70000"));

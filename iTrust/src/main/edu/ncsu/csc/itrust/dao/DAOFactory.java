...
public class DAOFactory {
	...
	*//**
	 *
	 * @return this DAOFactory's AnonymizedTransactionDAO
	 *//*
	public AnonymizedTransactionDAO getAnonymizedTransactionDAO() {
		return new AnonymizedTransactionDAO(this);
	}
	...
	*//**
	 * Creates a new DAO for retrieving and storing message filters
	 * @return this DAO factory's MessageFiltersDAO
	 *//*
	public MessageFiltersDAO getMessageFiltersDAO() { return new MessageFiltersDAO(this); }

    *//**
     * Creates a new DAO for activating preregistered patient
     * @return this DAOFactory's PrPatientDAO
     *//*
    public PrPatientDAO getPrPatientDao() { return new PrPatientDAO(this); }

    *//**
     * Creates a new DAO for death report
     * @return this DAOFactory's DeathReportDAO
     *//*
    public DeathReportDAO getDeathReportDAO() {
		return new DeathReportDAO(this);
	}

...
<script type="text/javascript">
	$( document ).ready(function(){
		...
		var betterSayings = jQuery.map(sayings, function(value, ind) {
		    var stripped = jQuery.trim(value);
			var puncStripped = stripped.replace(/[^0-9a-zA-Z]+$/, "");
		    return (puncStripped + ", if you will.");
		});
		var index = Math.floor((Math.random()*betterSayings.length)+1);
		$('.jenkins-quote').html(betterSayings[index]);
